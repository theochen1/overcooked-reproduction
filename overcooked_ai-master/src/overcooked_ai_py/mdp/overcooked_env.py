...
class OvercookedEnv(object):
    ...
    def lossless_state_encoding_mdp_legacy(self, state):
        """
        Wrapper of the mdp's legacy 20-channel lossless_encoding.
        Use this for reproducing 2019 paper results.
        """
        return self.mdp.lossless_state_encoding_legacy(state)
