...
from human_aware_rl_jax_lift.agents.ppo.train import PPOConfig
from human_aware_rl_jax_lift.config import get_hparams, get_tf_compat
...
def main() -> None:
    ...
    parser.add_argument("--tf_compat", action=argparse.BooleanOptionalAction, default=None, help="Enable tf_compat mode. Default: read from paper_config.yaml tf_compat flag.")
    ...
    summaries = ppo_run(
        ...
        tf_compat=args.tf_compat if args.tf_compat is not None else get_tf_compat(),
    )
